...
<head>
    ...
    <meta name="description" content="A research group dedicated to the advancement of quality science">
    <meta name="author" content="Research Programming Consultants LLC">

    <title>Research Programming Consultants</title>
...
<header>
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Research is tough</div>
            <div class="intro-heading">Let us help you find the solution</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Help is just around the corner</h3>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading">Industry Standard Programming</h4>
                <p class="text-muted">With over 13 years of experience in the Financial </p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
